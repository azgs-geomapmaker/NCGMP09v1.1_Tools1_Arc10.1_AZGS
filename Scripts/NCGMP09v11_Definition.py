...
#  Modified by Janel Day, Spring 2014:
#        SysInfo Table added
#        Notes Table added
#        GPSX field added to Stations
#        GPSY field added to Stations
#        MapX field added to Stations
#        MapY field added to Stations       
#        Memo length increased from 5000

versionString = 'NCGMP09v11_Definition.py, version of 7 February 2012'
...
startDict = {'SysInfo': 				[['Sub','String','NullsOK',defaultLength],
													['Pred','String','NullsOK',defaultLength],
													['Obj','String','NullsOK',IDLength]],
			'DescriptionOfMapUnits':  	[['MapUnit','String','NullsOK',mapUnitLength],  
					...
					['Description','String','NullsOK',memoLength],
                                        ['GeneralLithology','String','NullsOK',defaultLength],
                                        ['GeneralLithologyConfidence','String','NullsOK',defaultLength],
                                        ['HierarchyKey','String','NullsOK',defaultLength],
 		   ...
 		   'DataSources':      [['Source','String','NullsOK',defaultLength],
					['Notes','String','NullsOK',memoLength]],
               'ExtendedAttributes':   [['OwnerTable','String','NullsOK',defaultLength],
					['OwnerID','String','NullsOK',IDLength],
					['Property','String','NullsOK',defaultLength],
					...
					['Notes','String','NullsOK',memoLength]],
                     'Notes':           [['OwnerTable','String','NullsOK',defaultLength],
					['OwnerID','String','NullsOK',IDLength],
					['Type','String','NullsOK',defaultLength],					
                                        ['DataSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
               'GeologicEvents':       [['Event','String','NullsOK',defaultLength],
					...
					['DataSourceID','String','NullsOK',IDLength]],
               'Glossary':             [['Term','String','NullsOK',defaultLength],
					['Definition','String','NullsOK',memoLength],
					['DefinitionSourceID','String','NullsOK',IDLength]],
               'StandardLithology':    [['MapUnit','String','NullsOK',mapUnitLength],
					...
					['DataSourceID','String','NullsOK',IDLength]],
             'RepurposedSymbols':      [['FgdcIdentifier','String','NullsOK',defaultLength],
                                        ['OldExplanation','String','NullsOK',defaultLength],
                                        ['NewExplanation','String','NullsOK',defaultLength]],
		   'ChangeLog':	       [['OwnerTable','String','NullsOK',defaultLength],
					['OwnerID','String','NullsOK',IDLength],
					['ChangedWhen','Date','NullsOK'],
					['ChangedBy','String','NullsOK',defaultLength],
					['OldValue','String','NullsOK',memoLength],
					['NewValue','String','NullsOK',memoLength],
					['Notes','String','NullsOK',memoLength]],
               'CMULines':             [['Type','String','NullsOK',defaultLength],
					['Symbol','String','NullsOK',defaultLength]],
	'ContactsAndFaults':           [['Type','String','NullsOK',defaultLength],
					['IsConcealed','String','NullsOK',booleanLength],
					['ExistenceConfidence','String','NullsOK',IDLength],
                                        ['IdentityConfidence','String','NullsOK',IDLength],
                                        ['LocationConfidenceMeters','Single','NullsOK'],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
                                        ['DataSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
		   'GeologicLines':    [['Type','String','NullsOK',defaultLength],
                                        ['IsConcealed','String','NullsOK',booleanLength],
					['ExistenceConfidence','String','NullsOK',IDLength],
                                        ['IdentityConfidence','String','NullsOK',IDLength],
                                        ['LocationConfidenceMeters','Single','NullsOK'],
					...
					['Label','String','NullsOK',IDLength],
                                        ['DataSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
	        'IsoValueLines':       [['Type','String','NullsOK',defaultLength],
                                        ['Value','Single','NullsOK'],
					['LocationConfidenceMeters','Single','NullsOK'],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
                                        ['DataSourceID','String','NullsOK',IDLength],
	       ...
	       'CartographicLines':    [['Type','String','NullsOK',defaultLength],
					...
					['Label','String','NullsOK',IDLength],
                                        ['DataSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
               'MapUnitPolys':         [['MapUnit','String','NullsOK',mapUnitLength],
                                        ['IdentityConfidence','String','NullsOK',IDLength],
                                        ['Label','String','NullsOK',IDLength],
                                        ['Symbol','String','NullsOK',defaultLength],
                                        ['Label','String','NullsOK',IDLength],
                                        ['Notes','String','NullsOK',memoLength],
                                        ['DataSourceID','String','NullsOK',IDLength]],
                 'OtherPolys':         [['Type','String','NullsOK',defaultLength],
                                        ['IdentityConfidence','String','NullsOK',IDLength],
                                        ['Symbol','String','NullsOK',defaultLength],
                                        ['Label','String','NullsOK',IDLength],
                                        ['Notes','String','NullsOK',memoLength],
               ...
               'DataSourcePolys':      [['Notes','String','NullsOK',memoLength],
					['DataSourceID','String','NullsOK',IDLength]],
        'CMUMapUnitPolys':             [['MapUnit','String','NullsOK',mapUnitLength],
					['Label','String','NullsOK',IDLength],
					['Symbol','String','NullsOK',defaultLength]],
               'CMUPoints':            [['Type','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
					['Symbol','String','NullsOK',defaultLength]],
             'CMUText':                [['ParagraphStyle','String','NullsOK',defaultLength],
		   ...
		   'Stations':         [['FieldID','String','NullsOK',IDLength],
					['MapUnit','String','NullsOK',mapUnitLength],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
					['PlotAtScale','Single','NullsOK'],
					['LocationConfidenceMeters','Single','NullsOK'],
					...
					['DataSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
		'GenericPoints':       [['Type','String','NullsOK',defaultLength],
					...
					['PlotAtScale','Single','NullsOK'],
					['LocationConfidenceMeters','Single','NullsOK'],
					['LocationSourceID','String','NullsOK',IDLength],
					['DataSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
		'GenericSamples':      [['Type','String','NullsOK',defaultLength],
					['StationID','String','NullsOK',IDLength],
					['MapUnit','String','NullsOK',mapUnitLength],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
					...
					['LocationSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
		'OrientationPoints':   [['Type','String','NullsOK',defaultLength],
                                        ['StationID','String','NullsOK',IDLength],
					['MapUnit','String','NullsOK',mapUnitLength],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
					['PlotAtScale','Single','NullsOK'],
					['LocationConfidenceMeters','Single','NullsOK'],
					['Azimuth','Single','NullsOK'],
					['Inclination','Single','NullsOK'],
					['IdentityConfidence','String','NullsOK',50],
					['OrientationConfidenceDegrees','Single','NullsOK'],
					['LocationSourceID','String','NullsOK',IDLength],
					['DataSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength],
					['SymbolRotation','Double', 'NullsOK']],
                'GeochronPoints':      [['Type','String','NullsOK',defaultLength],
					['StationID','String','NullsOK',IDLength],
					['MapUnit','String','NullsOK',mapUnitLength],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
					...
					['AgeUnits','String','NullsOK',IDLength],
					['LocationSourceID','String','NullsOK',IDLength],
					['AnalysisSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]],
		   'FossilPoints':     [['Type','String','NullsOK',defaultLength],
					['StationID','String','NullsOK',IDLength],
					['MapUnit','String','NullsOK',mapUnitLength],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
					...
					['PlotAtScale','Single','NullsOK'],
					['LocationConfidenceMeters','Single','NullsOK'],
					['FossilForms','String','NullsOK',memoLength],
					['FossilAge','String','NullsOK',defaultLength],
					['LocationSourceID','String','NullsOK',IDLength],
					['FossilFormsSourceID','String','NullsOK',IDLength],
					['FossilAgeSourceID','String','NullsOK',IDLength],
					['Notes','String','NullsOK',memoLength]], 
		'PhotoPoints':         [['Type','String','NullsOK',defaultLength],
					['StationID','String','NullsOK',IDLength],
					['MapUnit','String','NullsOK',mapUnitLength],
					['Symbol','String','NullsOK',defaultLength],
					['Label','String','NullsOK',IDLength],
					...
					['LocationSourceID','String','NullsOK',IDLength],
					['DataSourceID','String','NullsOK',IDLength],
                                        ['PhotoID','String','NullsOK',IDLength],
...
for table in startDict.keys():
	...
	newfields = []
	newfields.append([table+'_ID','String','NullsOK',IDLength])
